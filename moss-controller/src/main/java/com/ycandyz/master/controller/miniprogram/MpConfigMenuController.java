...
public class MpConfigMenuController extends BaseController<MpConfigMenuServiceImpl,MpConfigMenu,MpConfigMenuQuery> {
	...
	public ReturnResponse<MpConfigMenu> create(@Validated(ValidatorContract.OnCreate.class) MpConfigMenu entity) {
        return returnResponse(service.save(entity),entity,"保存失败!");
	}
	
	@ApiOperation(value = "通过ID更新")
    @PutMapping(value = "/menus/{id}")
	public ReturnResponse<MpConfigMenu> updateById(@PathVariable Integer id,@Validated(ValidatorContract.OnUpdate.class) MpConfigMenu entity) {
        entity.setId(id);
	...
	public ReturnResponse<MpConfigMenu> getById(@PathVariable Integer id) {
    ...
    public ReturnResponse<Page<MpConfigMenu>> selectPage(Page page, MpConfigMenuQuery query) {
        return ReturnResponse.success(service.page(page,query));
    }
    
    @ApiOperation(value = "列表查询-默认菜单", tags = "小程序配置")
    @GetMapping(value = "/menus")
    public ReturnResponse<List<MpConfigMenu>> selectList(MpConfigMenuQuery query) {
        return ReturnResponse.success(service.list(query));
    }
    
    @ApiOperation(value = "通过ID删除")
    @DeleteMapping(value = "/menus/{id}")
	public ReturnResponse<MpConfigMenu> deleteById(@PathVariable Integer id) {
	...
	public ReturnResponse<MpConfigMenu> deleteBatch(String ids) {
