...
import com.ycandyz.master.domain.model.mall.MallItemVideoComplaintModel;
...
public class MallItemVideoComplaintController extends BaseController<MallItemVideoComplaintServiceImpl,MallItemVideoComplaint,MallItemVideoComplaintQuery> {
    ...
    @PostMapping
	public CommonResult<MallItemVideoComplaint> insert(@Validated(ValidatorContract.OnCreate.class) MallItemVideoComplaintModel model) {
        MallItemVideoComplaint entity = new MallItemVideoComplaint();
