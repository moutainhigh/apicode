...
public class SpreadMallItemPageRespInfo {
    ...
    @ApiModelProperty(name = "global_is_enable", value = "是否开启分销")
    private Integer globalIsEnable;

    @ApiModelProperty(name = "is_updated_share", value = "是否设置过分销")
    private Integer isUpdatedShare;

    @ApiModelProperty(name = "global_share_method", value = "U团长分销佣金的方式0:按比例 1:按金额")
    private Integer globalShareMethod;
