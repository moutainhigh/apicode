 ...
 * @author WangWx
 * @version 2.0
 * @Description 商品推荐基础表 Resp
 * @since 2021-01-12
 */
@Data
@JsonNaming(PropertyNamingStrategy.SnakeCaseStrategy.class)
@ApiModel(description = "商品推荐基础表-Resp")
public class MallItemRecommendResp implements Serializable {
    ...
    @ApiModelProperty(name = "show_name", value = "默认是否推荐 0不推荐 1推荐")
    private String showName;

    @ApiModelProperty(name = "recommend_content", value = "默认推荐方式 1自动推荐 2手动选择")
    ...
    @ApiModelProperty(name = "recommend_item", value = "商品信息")
    private List<MallItemRecommendRelationResp> recommendItem;
}
