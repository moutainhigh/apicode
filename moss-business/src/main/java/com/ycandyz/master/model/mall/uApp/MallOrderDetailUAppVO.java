...
import com.ycandyz.master.model.mall.MallOrderDetailSpecVO;
import com.ycandyz.master.model.mall.MallSocialShareFlowVO;
...
public class MallOrderDetailUAppVO {
    ...
    private List<MallOrderDetailSpecUAppVO> specs;
    /**是否可以分销*/
